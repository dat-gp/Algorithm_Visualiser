...
def disp_digit(divisor, passes):
    ...
    # Blank line logic
    x1 = 770 + (50*passes)              # x1 for Pass 3 920, x1 for pass 2 870, x1 for Pass 3
...
def radix_sort(arr, n): 
    ...
    while i<passes:                             
        ...
        buckets = [[] for i in range(10)]                    # creating 10 empty buckets

        disp_buckets()
        
        # Initialiseing count of elements in the buckets to 0  
        ...
        for j in range(n):
            ...
            # check the bucket no. of a number
