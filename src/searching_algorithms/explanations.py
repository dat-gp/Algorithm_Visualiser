'''
This module is responsible for displaying explanations for each algorithm on the main screen.
They are displayed when the mouse hovers over a particular button. (not strictly)
Function names in this module are passed as arguments from main_screen during button obj. creation
'''

# Imports
import pygame
from src.helpers.constants import WINDOW, WINDOW_WIDTH, COLOR, FONT

# Explaination frame - rectangular window in which explanations are displayed on the main_screen
FRAME = pygame.Rect(0,300,WINDOW_WIDTH,300)

def none():
    '''
    Some Buttons have no explanation
    '''
    pass
